...
public class ResponseExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleNoHandlerFoundException(NoHandlerFoundException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        Object errorResponse = new ErrorResponse(RestExceptionCode.FC_RE_001, "Método não encontrado");
    ...
    public ResponseEntity<ErrorResponse> handleBadCredentials(Exception ex) {
    	ErrorResponse errorResponse = new ErrorResponse(RestExceptionCode.FC_RE_001, "Autorização necessária");
    ...
    public ResponseEntity<ErrorResponse> handleAccessDenied(Exception ex) {
        ErrorResponse errorResponse = new ErrorResponse(RestExceptionCode.FC_RE_001, "Acesso negado");
        return new ResponseEntity<>(errorResponse, HttpStatus.UNAUTHORIZED);
    }
